...
studied_row = 200
max_scale = 600
np.linspace(0,image.shape[1], 1000)
sampling_period = np.diff().mean()
widths = np.geomspace(1, max_scale, num=100)
cwtmatr, freqs = pywt.cwt(image[studied_row,:,0], widths, 'haar', sampling_period=sampling_period)  # Ondelette de Morlet
