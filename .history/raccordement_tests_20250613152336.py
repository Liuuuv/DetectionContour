...
line_plot(column_list, intensity_list, marker='+')


# temp = scipy.interpolate.interp1d(column_list, intensity_list)
temp = scipy.interpolate.splrep(column_list, intensity_list, s=0)
ynew = scipy.interpolate.splev(column_list, temp, der=0)

plt.title("1-D Interpolation")
plt.plot(column_list, ynew, '-', color="green")
