...
changes = np.pad(changes, ((0, 1), (0, 0), (0, 0)), mode='constant')


# Marquer le pixel avant ET après chaque changement
image1 = np.zeros_like(image1, dtype=np.uint8)
image1[1:][changes] = 255  # Pixel après le changement
image1[:-1][changes] = 255 # Pixel avant le changement
