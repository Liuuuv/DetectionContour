...
for i in range(matrix_size[0] * matrix_size[1]):
    for product in vectorized_matrix[i]:
        convolution_matrix[i,square_to_column_dict[(product[0][0]-1,product[0][1]-1)]] = (product[1][0] - kernel.center[0], product[1][1] - kernel.center[1])
