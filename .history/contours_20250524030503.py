...
image = image[::10, ::10, :]  # 5:taille (115, 128, 3), 4:taille (144, 160, 3)
image[:,:]/255
...
image_path = "justdisappear.jpg"  # Remplacez par votre chemin
image = np.array(Image.open(image_path).convert('L'))  # 'L' = niveaux de gris

# 2. Calculer la transformée de Fourier 2D
...
# 4. Afficher l'image originale et son spectre
...
plt.subplot(1, 2, 2)
plt.imshow(magnitude_spectrum, cmap='magma')  # Colormap 'magma' comme demandé
