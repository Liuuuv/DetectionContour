...
spline2 = scipy.interpolate.UnivariateSpline(column_list, intensity_list, s=.05)
...
line_plot(column_list_fin, spline2(column_list_fin), '-', color="red")
plt.scatter(column_list, intensity_list, marker='+')
