...
def black_and_white(img_):
    """
    Convert color image to black and white using numpy vectorization
    
    Args:
        img_: Input color image (3-channel array)
    
    Returns:
        Grayscale version (3-channel array with equal values)
    """
