...
sign_changes = np.diff(np.sign(image1), axis=0) != 0
    
# Ajout d'une ligne/colonne de 0 pour conserver la forme originale
image1 = np.pad(sign_changes.astype(np.uint8), 
                ((0,1), (0,0)), 
                'constant') * 255
