...
def edge_detection_2(img):
    ...
    img_ = (2*(image_x ** 2 * image_xx + 4 * image_x * image_y * image_xy + image_y ** 2 * image_yy)/magnitude**2)
...
# image1 = np.where(changes, 1,0)



# image1 = np.zeros_like(image1, dtype=np.uint8)
# image1[:][changes] = 1  # Pixel après le changement
# image1[:][changes] = 1 # Pixel avant le changement
