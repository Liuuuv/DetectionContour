...
# 1. Charger une image
image = np.random.rand(100, 100)  # Remplacez par votre image

# 2. Transformée de Radon (approximation curvelet)
theta = np.linspace(0, 180, 360, endpoint=False)
sinogram = radon(image, theta=theta)

# 3. Reconstruction pour détection de contours
edge_map = iradon(sinogram, theta=theta, filter_name='ramp')
